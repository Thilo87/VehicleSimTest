...
#include "TrafficSimulation/AiControlledCar/TrafficSimAiControlledSportsCar.h"

#include "Pawns/VehicleTestSportsWheelFront.h"
#include "Pawns/VehicleTestSportsWheelRear.h"

ATrafficSimAiControlledSportsCar::ATrafficSimAiControlledSportsCar()
{
		// Set up the chassis
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVehicleTestSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVehicleTestSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVehicleTestSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVehicleTestSportsWheelRear::StaticClass();
