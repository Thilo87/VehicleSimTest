...
AVehicleTestOffroadCar::AVehicleTestOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVehicleTestOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVehicleTestOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVehicleTestOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVehicleTestOffroadWheelRear::StaticClass();
